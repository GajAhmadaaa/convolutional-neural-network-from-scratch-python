...
train_images -= float(np.mean(train_images))
train_images //= float(np.std(train_images))
test_images -= float(np.mean(test_images))
test_images //= float(np.std(test_images))
